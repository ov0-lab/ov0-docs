...
import { sortedPlugins, type PluginInfo } from '@site/static/tags';
...
const favoriteUsers = sortedPlugins.filter((plugin) =>
...
function HeadingAllSites() {
  return (
    <Heading as="h2">
      <Translate id="showcase.usersList.allUsers">全部插件</Translate>
    </Heading>
  );
}

function CardList({ heading, items }: { heading?: ReactNode; items: PluginInfo[] }) {
  return (
